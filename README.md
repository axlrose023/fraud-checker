...
**Пример `.env`:**
```bash
APP__API__API_KEY=JOC4PWHeadqLxuqKTwwqLCqYAKuch7DuaGde2jHoCm4
APP__FRAUD__TURNSTILE_SITE_KEY=0x4AAAAAACbxPl-VwQMoXtYM
APP__FRAUD__TURNSTILE_SECRET_KEY=0x4AAAAAACbxPtlEXYQS_0ma8-FMDz_1YXw
